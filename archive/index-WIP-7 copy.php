    ...
    <header class="w-full bg-white shadow-sm fixed top-0 left-0 z-40">
      ...
      >
        <a href="/" class="flex items-center space-x-3 group">
          ...
          <span
            class="text-sm md:text-lg font-bold text-gray-900 group-hover:text-primary transition-colors">
            DesignSpark
          </span>
        </a>
            ...
            <div class="p-6 flex-1 flex flex-col">
              ...
              <div class="mt-6 p-4 bg-white/10 rounded-xl border border-white/20">
                <div class="flex items-center justify-center mb-2">
                  ...
                  <span class="text-white font-semibold text-sm">Monthly Club Guarantee</span>
                </div>
                <p class="text-white/90 text-sm text-center leading-relaxed">
      ...
      <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-12">
          ...
          <div class="space-y-4" id="faq-accordion-monthly">
            <div class="bg-gray-50 rounded-lg overflow-hidden animate-on-scroll">
              <button
            ...
            <div
              class="bg-gray-50 rounded-lg overflow-hidden animate-on-scroll delay-1"
            >
              <button
                class="w-full px-6 py-4 text-left font-semibold flex justify-between items-center faq-toggle"
                data-faq="faq-4"
            ...
            <div
              class="bg-gray-50 rounded-lg overflow-hidden animate-on-scroll delay-2"
            >
              <button
                class="w-full px-6 py-4 text-left font-semibold flex justify-between items-center faq-toggle"
                data-faq="faq-5"
            ...
            <div
              class="bg-gray-50 rounded-lg overflow-hidden animate-on-scroll delay-3"
            >
              <button
                class="w-full px-6 py-4 text-left font-semibold flex justify-between items-center faq-toggle"
                data-faq="faq-6"
            ...
            <div
              class="bg-gray-50 rounded-lg overflow-hidden animate-on-scroll delay-4"
            >
              <button
                class="w-full px-6 py-4 text-left font-semibold flex justify-between items-center faq-toggle"
                data-faq="faq-8"
