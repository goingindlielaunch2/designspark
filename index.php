        ...
        <div class="animate-on-scroll">
          ...
          <div class="mb-6 animate-on-scroll">
            ...
            >
              ...
              ></div>
              <span>Booking for <?php echo date('F'); ?></span>
            </div>
          </div>
...
<p class="text-xl text-gray-600 max-w-3xl mx-auto">Real feedback from website owners who I've worked with</p>
    ...
    <section class="py-20 bg-white">
      <!-- <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Placeholder Reviews -->
        <!-- <div class="grid grid-cols-1 md:grid-cols-3 gap-8 animate-on-scroll delay-1"> -->
          <!-- Sample Review 1 -->
          <!-- <div class="bg-gradient-to-br from-white to-slate-50 rounded-2xl shadow-lg p-8 border border-slate-200 relative overflow-hidden min-h-[320px] flex flex-col">
            <div class="flex justify-between items-start mb-6">
              <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-gradient-to-r from-yellow-100 to-amber-100 text-yellow-800 border border-yellow-200/50 shadow-sm">
                ⭐ Customer Review
              </span>
              <div class="text-right">
                <div class="text-yellow-400 text-xl mb-1 drop-shadow-sm">★★★★★</div>
                <span class="text-sm text-slate-600 font-medium bg-slate-100 px-2 py-1 rounded-full">5/5</span>
              </div>
            </div>
            
            <div class="flex-1 flex items-center">
              <blockquote class="text-slate-700 text-lg leading-relaxed font-medium text-center">
                "Outstanding service! Fixed my website issues quickly and professionally. Highly recommend for anyone needing website help."
              </blockquote>
            </div>
            
            <div class="flex items-center justify-center mt-8 pt-6 border-t border-slate-200">
              ...
              <div class="ml-4 text-center">
                <p class="text-lg font-semibold text-slate-900">Sarah Johnson</p>
                <p class="text-sm text-slate-600 font-medium">Business Owner</p>
              </div>
            </div>
          </div> -->
          ...
          <!-- <div class="bg-gradient-to-br from-white to-slate-50 rounded-2xl shadow-lg p-8 border border-slate-200 relative overflow-hidden min-h-[320px] flex flex-col">
            ...
            <div class="flex-1 flex items-center">
              <blockquote class="text-slate-700 text-lg leading-relaxed font-medium text-center">
                "The website analysis was incredibly detailed and actionable. Implemented the suggestions and saw immediate improvements in user engagement."
              </blockquote>
            </div>
            ...
            <div class="flex items-center justify-center mt-8 pt-6 border-t border-slate-200">
              ...
              <div class="ml-4 text-center">
                <p class="text-lg font-semibold text-slate-900">Michael Chen</p>
                <p class="text-sm text-slate-600 font-medium">E-commerce Store</p>
              </div>
            </div>
          </div> -->
          ...
          <!-- <div class="bg-gradient-to-br from-white to-slate-50 rounded-2xl shadow-lg p-8 border border-slate-200 relative overflow-hidden min-h-[320px] flex flex-col">
            ...
            <div class="flex-1 flex items-center">
              <blockquote class="text-slate-700 text-lg leading-relaxed font-medium text-center">
                "Fast, reliable, and expert service. My WordPress site was running perfectly after their optimization work. Great communication throughout."
              </blockquote>
            </div>
            ...
            <div class="flex items-center justify-center mt-8 pt-6 border-t border-slate-200">
              ...
              <div class="ml-4 text-center">
                <p class="text-lg font-semibold text-slate-900">Emily Rodriguez</p>
                <p class="text-sm text-slate-600 font-medium">Nonprofit Director</p>
              </div>
            </div>
          </div>
        </div> -->
      ...
      <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <div class="text-gray-600 mb-6 text-xs text-center flex items-center justify-center py-4">
              ...
              <span>Need more fixes than just one? Update qty on Get Started page.</span>
            </div>
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        ...
        function runAutomatedChecks(name, email, url, newsletter) {
          console.log("Starting automated checks for:", url);
          ...
          fetch("api_handler.php", { method: "POST", body: formData })
            ...
            .then((data) => {
              ...
              console.log("Successfully stored AI report data");
            })
            .catch((error) => {
            ...
            .finally(() => {
              apiDone = true;
              console.log("API call finished. trackerDone:", trackerDone, "apiError:", apiError);
              if (trackerDone) showResults(apiError);
            });
          runTrackerAnimation(() => {
            trackerDone = true;
            console.log("Tracker animation finished. apiDone:", apiDone, "apiError:", apiError);
            if (apiDone) showResults(apiError);
          });
        }

        function showResults(error = null) {
          console.log("showResults called with error:", error, "aiReportData:", aiReportData);
          ...
          if (!aiReportData) {
            console.error("No aiReportData available");
            alert("Could not retrieve AI report. Please try again.");
            restart();
            return;
          }
        ...
        function displayInitialReport() {
          if (!aiReportData || !aiReportData.basicReport) {
            alert("Error: No report data available. Please try analyzing your website again.");
            restart();
            return;
          }
          ...
          if (!scores || !topOpportunities) {
            alert("Error: Invalid report data. Please try analyzing your website again.");
            restart();
            return;
          }
          ...
          if (!categoryScoresContainer || !feedbackList || !overallScoreText || !scoreCircle) {
            return;
          }
          ...
          try {
            ...
            scoresArray.forEach((cat, index) => {
              ...
              const scoreHtml = `<div class="slide-in-up" style="animation-delay: ${
                index * 100
            ...
            topOpportunities.forEach((opp, index) => {
              const oppHtml = `<div class="flex gap-4 items-start"><div class="w-12 h-12 rounded-full bg-indigo-100 flex-shrink-0 flex items-center justify-center"><svg class="w-6 h-6 text-indigo-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 3l2.53 7.68h8.08l-6.54 4.76 2.5 7.69L12 18.37l-6.55 4.76 2.5-7.69L1.41 10.68h8.08L12 3z" /></svg></div><div class="flex-1"><p class="text-slate-600 leading-relaxed">${opp}</p></div></div>`;
            ...
            alert("Error displaying the report. Please try again.");
          }
        }
